...
if (isset($_POST['submit'])) {
  ...
  if (mail($to, $subject, $message, $headers)) {
    $success_msg = "Sua mensagem foi enviada com sucesso.";
    $_POST = array(); // Limpa os campos do formulário
  } else {
    $error_msg = "Houve um problema ao enviar sua mensagem. Tente novamente mais tarde.";
  }
}
?>
...
<form action="mailer.php" method="post" enctype="multipart/form-data">
  ...
  <?php if (isset($error_msg)): ?>
    <div class="alert alert-danger messenger-box-contact__msg" role